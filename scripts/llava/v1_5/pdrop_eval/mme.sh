...
python -m llava.eval.model_vqa_loader \
    ...
    --question-file /wekafs/aditysin/PyramidDrop/data/playground/data/eval/MME/llava_mme.jsonl \
    --image-folder /wekafs/aditysin/PyramidDrop/data/playground/data/eval/MME/MME_Benchmark_release_version \
    --answers-file /wekafs/aditysin/PyramidDrop/data/playground/data/eval/MME/answers/llava-v1.5-7b_${CUSTOM_NAME}.jsonl \
    --temperature 0 \
...
cd /wekafs/aditysin/PyramidDrop/data/playground/data/eval/MME

python convert_answer_to_mme.py --experiment llava-v1.5-7b_${CUSTOM_NAME}

cd eval_tool

python calculation.py --results_dir answers/llava-v1.5-7b_${CUSTOM_NAME}
