...
export WANDB_API_KEY=9e100666af3d831d53b4458f6043e4c2fe569b98
...
deepspeed videollava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /wekafs/hkandala/checkpoints/videollava-7b-pretrain-vzpd/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir /wekafs/hkandala/checkpoints/videollava-7b-vzpd-lora-test \
    --run_name VZPD-finetune-video-lora-vzpd-final \
    --num_train_epochs 1 \
